      ...
      <el-descriptions-item label="标签">
        <xn-text :content="msg">
          <el-link
            :underline="false"
            type="primary"
            @click="$confirm('关上！', '友情提示', { type: 'error',showCancelButton:false,confirmButtonText:'我错了' })"
            >点击插槽按钮</el-link
          >
        </xn-text>
      </el-descriptions-item>
      <el-descriptions-item label="标签">
        <xn-text content="" empty-text="缺省默认值"></xn-text>
      </el-descriptions-item>
      <el-descriptions-item label="默认空值">
        <xn-text :content="text" show-action></xn-text>
      </el-descriptions-item>
      <el-descriptions-item label="标签">
