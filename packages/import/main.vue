<template>
  <xn-dialog title="批量导入" :show.sync="show" :before-close="onClose" @on-confirm="handleConfirm">
    <div class="xn-import">
      <el-link class="mb-20" type="success" icon="el-icon-download" :underline="false" @click="handleDownload">下载模板</el-link>
      <el-upload
        ref="import"
        action="###"
        v-bind="$attrs"
      ...
      <div slot="desc" class="xn-import-desc mt-10 fz-12">
        ...
        >
          <div>
            <p>1、非系统模板的文件会导入失败，请务必使用系统模板，点击上方按钮进行下载</p>
            <p>2、导入期间请勿进行其他操作</p>
            <p>3、导入为替换操作，请谨慎操作</p>
          </div>
        </el-alert>
