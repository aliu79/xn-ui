...
const add = function(...args) {
  return new Maths('add').result(...args)
}
// 减法
const sub = function(...args) {
  return new Maths('sub').result(...args)
}

const mul = function(...args) {
  return new Maths('mul').result(...args)
}
const div = function(...args) {
  return new Maths('div').result(...args)
}
const autoComputed = function(fields = [], fieldsRules = {}, field = '', value) {
  return new Maths().autoComputed(fields, fieldsRules, field, value)
}
export default {
  add,
  sub,
